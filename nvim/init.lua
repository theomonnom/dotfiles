...
vim.keymap.set("n", "S", require('hop').hint_lines, {
    desc = "HopLine"
})
...
vim.keymap.set("n", "<leader>dn", require("dap").step_into, {
    desc = "DAP: Step into"
})
vim.keymap.set("n", "<leader>dN", require("dap").step_back, {
    desc = "DAP: Step back"
})
vim.keymap.set("n", "<leader>dr", require("dap").repl.toggle, {
    desc = "DAP: Toggle REPL"
})
vim.keymap.set("n", "<leader>d.", require("dap").goto_, {
    desc = "DAP: Go to"
})
vim.keymap.set("n", "<leader>dh", require("dap").run_to_cursor, {
...
vim.keymap.set("n", "<leader>dv", function()
    ...
    desc = "DAP-Telescope: Variables"
})

vim.keymap.set("n", "<leader>dc", function()
    require("telescope").extensions.dap.commands()
end, {
    desc = "DAP-Telescope: Commands"
})

vim.keymap.set({"n", "x"}, "<leader>dx", require("dapui").eval, {
    desc = "DAP-UI: Eval"
})
